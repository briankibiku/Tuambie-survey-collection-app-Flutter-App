...
class SurveyPage extends StatelessWidget {
  final Map surveyQuestions;

  const SurveyPage({required this.surveyQuestions});
  @override
          ...
          children: [
            Column(
              ...
              children: [
                ...
                mediumVerticalSizedBox,
                Text(
                  'Fill up answers to all questions',
                  style: TextStyle(fontSize: 15, fontWeight: FontWeight.w200),
                ),
                mediumVerticalSizedBox,
                CustomInputLabel(labelString: surveyQuestions['firstQuestion']
                    //  'Have you every heard of mswali?'
                    ),
                smallVerticalSizedBox,
                CustomTextFormField(),
                mediumVerticalSizedBox,
                CustomInputLabel(labelString: surveyQuestions['secondQuestion']
